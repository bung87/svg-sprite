            ...
            describe('creates a visually correct stylesheet resource in', function () {
                ...
                it('CSS format', function (done) {
                    ...
                    capturePuppeteer(preview, previewImage, function (error) {
                        ...
                        function (error, r) {
                            should(error).not.ok;
                            should.ok(r.equal, 'The generated CSS preview doesn\'t match the expected one!');
                            done();
                        });
                    });
                });
                    ...
                    sass.render({
                        ...
                        function (err, scssText) {
                            ...
                            capturePuppeteer(preview, previewImage, function (error) {
                                ...
                                function (error, r) {
                                    should(error).not.ok;
                                    should.ok(r.equal, 'The generated Sass preview doesn\'t match the expected one!');
                                    done();
                                });
                            });
                        }
                    ...
                    fs.readFile(lessFile, function (err, lessText) {
                        ...
                        less.render(lessText.toString(), {}, function (error, output) {
                            ...
                            capturePuppeteer(preview, previewImage, function (error) {
                                ...
                                function (error, r) {
                                    should(error).not.ok;
                                    should.ok(r.equal, 'The generated LESS preview doesn\'t match the expected one!');
                                    done();
                                });
                            });
                        });
                    ...
                    fs.readFile(stylusFile, function (err, stylusText) {
                        ...
                        stylus.render(stylusText.toString(), {}, function (error, output) {
                            ...
                            capturePuppeteer(preview, previewImage, function (error) {
                                ...
                                function (error, r) {
                                    should(error).not.ok;
                                    should.ok(r.equal, 'The generated Stylus preview doesn\'t match the expected one!');
                                    done();
                                });
                            });
                        });
            ...
            it('creates a visually correct stylesheet resource', function (done) {
                ...
                sass.render({
                    ...
                    function (err, scssText) {
                        ...
                        capturePuppeteer(preview, previewImage, function (error) {
                            should(error).not.ok;
                            looksSame( previewImage, path.join(__dirname, 'expected', 'png', 'css.horizontal.centered.html.png'), function (error, r) {
                                should(error).not.ok;
                                should.ok(r.equal, 'The generated Sass preview doesn\'t match the expected one!');
                                done();
                            });
            ...
            it('creates a visually correct stylesheet resource', function (done) {
                ...
                fs.readFile(lessFile, function (err, lessText) {
                    ...
                    less.render(lessText.toString(), {}, function (error, output) {
                        ...
                        capturePuppeteer(preview, previewImage, function (error) {
                            should(error).not.ok;
                            looksSame( previewImage, path.join(__dirname, 'expected', 'png', 'css.packed.centered.html.png'), function (error, r) {
                                should(error).not.ok;
                                should.ok(r.equal, 'The generated LESS preview doesn\'t match the expected one!');
                                done();
                            });
    ...
    describe('with mixed alignment and ' + align.length + ' SVG files', function () {
        ...
        describe('with «view» mode, vertical layout and CSS render type', function () {
            ...
            it('creates a visually correct stylesheet resource', function (done) {
                ...
                capturePuppeteer(preview, previewImage, function (error) {
                    should(error).not.ok;
                    looksSame(previewImage, path.join(__dirname, 'expected', 'png', 'css.vertical.mixed.html.png'),function (error, r) {
                        should(error).not.ok;
                        should.ok(r.equal, 'The generated CSS preview doesn\'t match the expected one!');
                        done();
                    });
